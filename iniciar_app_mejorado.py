#!/usr/bin/env python3
"""
Script mejorado para iniciar ChinginGenerator v4-PRO
Sin necesidad de ejecutable, inicia directamente el servidor
Corrige el problema del mensaje en japonés
"""
import sys
import os
import socket
    ...
    while puerto < 8100:
        try:
            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
                # Intentar bind en localhost y 0.0.0.0 para asegurar que esté libre
...
def main():
    print("=" * 60)
    print("CHINGINGENERATOR V4-PRO - INICIADOR MEJORADO")
    print("=" * 60)
